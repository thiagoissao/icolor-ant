...
#define RANDOM(buffer, result, cast, limit)                                    \
  {                                                                            \
    long int value;                                                            \
    lrand48_r(&buffer, &value);                                                \
    result = (cast)(value % limit);                                            \
  }
#define RANDOM_UNIT(buffer, result, cast)                                      \
  {                                                                            \
    long int value;                                                            \
    lrand48_r(&buffer, &value);                                                \
    result = (cast)value;                                                      \
...
#define RANDOM(seed, buffer, result, cast, limit)                              \
  {                                                                            \
    long int value;                                                            \
    nrand48_r(seed, &buffer, &value);                                          \
    result = (cast)(value % limit);                                            \
  }
#define RANDOM_UNIT(seed, buffer, result, cast)                                \
  {                                                                            \
    long int value;                                                            \
    nrand48_r(seed, &buffer, &value);                                          \
    result = (cast)value;                                                      \
